...
class WooCommerce_AWeber_Widget extends WP_Widget
{
	...
	function __construct() {
		...
		$this->widget_description = __( 'Display Web Forms created on AWeber.', 'ultimo-wooemail' );
		$this->widget_id = 'woocommerce_aweber_webform';
		$this->widget_name = __( 'WooCommerce AWeber WebForm', 'ultimo-wooemail' );
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => __( 'Subscribe to our Newsletter', 'ultimo-wooemail' ),
			'formcode' => ''
		);
		...
		if ( $account ) {
			...
			<p>
				<label
					for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title (optional):', 'ultimo-wooemail' ); ?></label>
			...
			<p>
				<label
					for="<?php echo $this->get_field_id( 'formcode' ); ?>"><?php _e( 'Choose your Web Form to use:', 'ultimo-wooemail' ) ?></label>
			...
			_e( 'Please authorise WooCommerce to access your AWeber account from the WooCommerce settings page.', 'ultimo-wooemail' );
		}
	} // End form()
