...
do_action( "uwooe_settings_mb_start_{$args['args']['key']}" );
...
<input type="hidden" name="uwooe[tools][triggered]" value="1">
<div class="container">
	<div class="col-md-12">
		<div class="row">
			<?php
			...
			foreach ( $args['args']['section']['section_tools'] as $tool ) {
				...
				<div class="col-sm-6 col-md-4">
					<div class="thumbnail <?php echo $count > 1 ? 'locked' : '';?>">
						<?php
							echo '<span class="settings-icon"><img src="' . plugins_url( '/../../assets/img/aweb'.$count.'.png', dirname(__FILE__)) . '" ></span> ';
						?>
		...
		do_action( "uwooe_settings_mb_end_{$args['args']['key']}" );
		?>
		</div>
	</div>
</div>
